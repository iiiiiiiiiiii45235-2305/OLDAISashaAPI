...
function keyboard_settings_list(chat_id, page, from_other_plugin)
    ...
    local row = 1
    keyboard.inline_keyboard[row] = { }
    keyboard.inline_keyboard[row][1] = { text = langs[lang].infoEmoji, callback_data = 'group_management' .. reverseGroupDataDictionary['tagalert'] }
    ...
    row = row + 1
    keyboard.inline_keyboard[row] = { }
    keyboard.inline_keyboard[row][1] = { text = langs[lang].infoEmoji, callback_data = 'group_management' .. reverseGroupDataDictionary['pmnotices'] }
    ...
    if data[tostring(chat_id)] then
        if tonumber(page) == 1 then
            keyboard.inline_keyboard[row][1] = { text = langs[lang].infoEmoji, callback_data = 'group_management' .. reverseGroupDataDictionary['lock_grouplink'] }
            keyboard.inline_keyboard[row][2] = { text = langs[lang].infoEmoji, callback_data = 'group_management' .. reverseGroupDataDictionary['lock_name'] }
            keyboard.inline_keyboard[row][3] = { text = langs[lang].infoEmoji, callback_data = 'group_management' .. reverseGroupDataDictionary['lock_photo'] }
            row = row + 1
            keyboard.inline_keyboard[row] = { }
            ...
            for var, value in pairsByKeys(data[tostring(chat_id)].settings.locks) do
                ...
                keyboard.inline_keyboard[row][1] = { text = langs[lang].infoEmoji, callback_data = 'group_management' .. reverseGroupDataDictionary[var:lower()] }
        ...
        row = row + 1
        keyboard.inline_keyboard[row] = { }
        keyboard.inline_keyboard[row][1] = { text = langs[lang].infoEmoji, callback_data = 'group_management' .. reverseGroupDataDictionary['strict'] }
