return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha blocca l\'opzione specificata.',
            '(#unlock|[sasha] sblocca) arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha sblocca l\'opzione specificata.',
            'OWNER',
            ...
            '(#lock|[sasha] blocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha blocca l\'impostazione specificata di <group_id>.',
            '(#unlock|[sasha] sblocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha sblocca l\'impostazione specificata di <group_id>.',
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha locks specified parameter.',
            '(#unlock|[sasha] sblocca) arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha unlocks specified parameter.',
            'OWNER',
            ...
            '(#lock|[sasha] blocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha locks <group_id>\'s specified setting.',
            '(#unlock|[sasha] sblocca) <group_id> arabic|bot|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha unlocks <group_id>\'s specified setting.',
