return {
    ...
    it =
    {
        ...
        banhammer =
        {
            ...
            "#restrict <id>|<username>|<reply>|from [send_messages] [send_media_messages] [send_other_messages] [add_web_page_previews]: Sasha applica all'utente specificato le restrizioni specificate  (se non specificate l'utente avrà di default tutte le restrizioni applicate).",
            "#unrestrict <id>|<username>|<reply>|from [<reason>]: Sasha rimuove le restrizioni dell'utente specificato.",
        ...
        delword =
        {
            ...
            "#delword <word>|<pattern>: Sasha mette|toglie una censura su <word>|<pattern>, quando verrà scritta una cosa censurata nei supergruppi Sasha eliminerà il messaggio mentre nei gruppi bannerà il membro.",
        },
        ...
        group_management =
        {
            ...
            "#permissions <id>|<username>|<reply>|from: Sasha manda una tastiera in privato con i permessi dell'utente specificato.",
            ...
            "<mute_type> può essere: all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video_note|voice_note",
        ...
        info =
        {
            ...
            "USER",
            "#id: Sasha manda l'id dell'utente e l'id del gruppo.",
            "#username: Sasha manda l'username dell'utente e l'username del gruppo.",
            ...
            "MOD",
            "#id <username>|<reply>|from: Sasha manda l'id dell'utente/della chat specificato/a.",
            "#username <id>|<reply>|from: Sasha manda l'username dell'utente/della chat specificato/a.",
    ...
    en =
    {
        ...
        banhammer =
        {
            ...
            "#restrict <id>|<username>|<reply>|from [send_messages] [send_media_messages] [send_other_messages] [add_web_page_previews]: Sasha restrict the specified user as specified (if not specified the user will have all the restrictions).",
        ...
        delword =
        {
            ...
            "#delword <word>|<pattern>: Sasha puts|removes a censorship on <word>|<pattern>, when someone writes it in supergroups the message is deleted and in normal groups the user is kicked.",
        },
        ...
        group_management =
        {
            ...
            "#permissions <id>|<username>|<reply>|from: Sasha sends an inline keyboard with the permissions of the specified user.",
            ...
            "<mute_type> can be: all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video_note|voice_note",
        ...
        info =
        {
            ...
            "USER",
            "#id: Sasha sends the id of the user and the id of the chat.",
            "#username: Sasha sends the username of the user and the username of the chat.",
            ...
            "MOD",
            "#id <username>|<reply>|from: Sasha sends the id of the specified user/chat.",
            "#username <id>|<reply>|from: Sasha sends the username of the specified user/chat.",
