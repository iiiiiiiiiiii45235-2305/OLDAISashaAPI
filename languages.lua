return {
    ...
    it =
    {
        ...
        banhammer =
        {
            ...
            '(#kick|[sasha] uccidi|sasha spara) <id>|<username>|<reply>|from: Sasha rimuove l\'utente specificato.',
            '(#ban|kaboom|[sasha] banna|[sasha] decompila|sasha esplodi) <id>|<username>|<reply>|from: Sasha banna l\'utente specificato e lo rimuove, se tenta di rientrare viene nuovamente rimosso.',
    ...
    en =
    {
        ...
        banhammer =
        {
            ...
            '(#kick|[sasha] uccidi|sasha spara) <id>|<username>|<reply>|from: Sasha kicks specified user.',
            '(#ban|kaboom|[sasha] banna|[sasha] decompila|sasha esplodi) <id>|<username>|<reply>|from: Sasha kicks and bans specified user, if he tries to join again it\'s automatically kicked.',
