return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            "`/[un]lock <setting_type>`: Sasha [s]blocca <setting\\_type>.",
            "<setting\\_type> può essere: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict",
            "`/[un]mute <mute_type>`: Sasha [s]muta <mute\\_type>.",
            "<mute\\_type> può essere: all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video\\_note|voice\\_note",
            "SUPERGROUP",
            ...
            "`/[un]mute <group_id> <mute_type>`: Sasha [s]muta <mute\\_type> in <group\\_id>.",
            "`/[textual]muteslist <group_id>`: Sasha manda la lista dei muti di <group\\_id>.",
            "`/[un]lock <group_id> <setting_type>`: Sasha [s]blocca <setting\\_type> in <group\\_id>.",
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            "`/[un]lock <setting_type>`: Sasha [un]locks <setting\\_type>.",
            ...
            "<mute\\_type> can be: all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video\\_note|voice\\_note",
            "SUPERGROUP",
            ...
            "`/[un]mute <group_id> <mute_type>`: Sasha [un]mutes <group\\_id>'s <mute\\_type>.",
            "`/[textual]muteslist <group_id>`: Sasha sends <group\\_id>'s mutes.",
            "`/[un]lock <group_id> <setting_type>`: Sasha [un]locks <group\\_id>'s <setting\\_type>.",
