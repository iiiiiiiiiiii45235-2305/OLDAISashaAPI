return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            "`<mute>` può essere: `all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video_note|voice_note`.",
            "SUPERGROUP",
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            "`<mute>` can be: `all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video_note|voice_note`.",
            "SUPERGROUP",
