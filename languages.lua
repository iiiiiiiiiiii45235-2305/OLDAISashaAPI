return {
    ...
    it =
    {
        ...
        help =
        {
            ...
            '(#textualhelp|sasha aiuto testuale): Sasha manda la lista dei plugin per cui è disponibile l\'help',
            '(#textualhelp|sasha aiuto testuale) <plugin_name>|<plugin_number>: Sasha mostra l\'aiuto per il plugin specificato.',
    ...
    en =
    {
        ...
        help =
        {
            ...
            '(#textualhelp|sasha aiuto testuale): Sasha sends a list of plugins for which there\'s the help',
            '(#textualhelp|sasha aiuto testuale) <plugin_name>|<plugin_number>: : Sasha sends the help of the specified plugin.',
