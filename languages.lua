return {
    ...
    en =
    {
        ...
        helpIntro = "Every '/' can be replaced with '!' or '#'.\nAll commands are Case Insensitive.\nSquare brackets means optional (AND YOU MUST NOT WRITE THEM).\n'|' means \"or\" (AND YOU MUST NOT WRITE IT).\nRound brackets MUST NOT BE WRITTEN.\nCurly brackets indicate something that vary with the user's input, what is inside these brackets helps you to understand the thing that should be put there (AND YOU MUST NOT WRITE THEM).\nTap on a command to copy it.\nIf you have questions see <code>/faq</code> first.\n{user} = {id}|{username}|{reply}|from\n\n",
