return {
    ...
    it =
    {
        ...
        banhammer =
        {
            ...
            '(#kick|[sasha] uccidi|sasha spara) <id>|<username>|<reply>|from [<reason>]: Sasha rimuove l\'utente specificato.',
            '(#ban|kaboom|[sasha] banna|[sasha] decompila|sasha esplodi) <id>|<username>|<reply>|from [<reason>]: Sasha banna l\'utente specificato e lo rimuove, se tenta di rientrare viene nuovamente rimosso.',
    ...
    en =
    {
        ...
        administrator =
        {
            ...
            '(#pmblock|sasha blocca pm) <id>|<username>|<reply>|from: Sasha blocks specified user.',
            '(#pmunblock|sasha sblocca pm) <id>|<username>|<reply>|from: Sasha unblocks specified user.',
        ...
        banhammer =
        {
            ...
            '(#warn|sasha avverti) <id>|<username>|<reply>|from [<reason>]: Sasha warns specified user.',
            '#unwarn <id>|<username>|<reply>|from [<reason>]: Sasha removes one warn from specified user.',
            '(#unwarnall|[sasha] azzera avvertimenti) <id>|<username>|<reply>|from [<reason>]: Sasha removes all warns from specified user.',
            '(#kick|[sasha] uccidi|sasha spara) <id>|<username>|<reply>|from [<reason>]: Sasha kicks specified user.',
            '(#ban|kaboom|[sasha] banna|[sasha] decompila|sasha esplodi) <id>|<username>|<reply>|from [<reason>]: Sasha kicks and bans specified user, if he tries to join again it\'s automatically kicked.',
            '(#unban|[sasha] sbanna|[sasha] [ri]compila) <id>|<username>|<reply>|from [<reason>]: Sasha unbans specified user.',
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) <group_id> arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha locks <group_id>\'s specified setting.',
            '(#unlock|[sasha] sblocca) <group_id> arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha unlocks <group_id>\'s specified setting.',
