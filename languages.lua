return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            '#settings: Sasha manda in privato una tastiera con la lista delle impostazioni.',
            '#textualsettings: Sasha mostra le impostazioni del gruppo.',
            '#muteuser|voce <id>|<username>|<reply>|from: Sasha imposta|toglie il muto sull\'utente.',
            '(#muteslist|lista muti): Sasha manda in privato una tastiera con la lista dei muti.',
            '#textualmuteslist: Sasha manda la lista dei muti della chat.',
            ...
            '<setting_type> può essere: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict',
            '#settings <group_id>: Sasha manda in privato una tastiera con la lista delle impostazioni di <group_id>.',
            '#textualsettings <group_id>: Sasha manda le impostazioni di <group_id>.',
        ...
        help =
        {
            ...
            '(#help|sasha aiuto): Sasha manda in privato una tastiera con la lista dei plugin per cui è disponibile l\'help.',
            '(#help|sasha aiuto) <plugin_name>|<plugin_number>: Sasha manda in privato l\'aiuto per il plugin specificato.',
            '#textualhelp: Sasha manda la lista dei plugin per cui è disponibile l\'help',
            '#textualhelp <plugin_name>|<plugin_number>: Sasha mostra l\'aiuto per il plugin specificato.',
        ...
        plugins =
        {
            ...
            'OWNER',
            '(#plugins|[sasha] lista plugins): Sasha manda in privato una tastiera con la lista dei plugin.',
            '#textualplugins: Sasha mostra una lista di tutti i plugins.',
            ...
            'SUDO',
            '(#plugins|[sasha] lista plugins) [chat]: Sasha manda in privato una tastiera con la lista dei plugin, se [chat] è specificato permette di modificare la lista del gruppo in cui è stato eseguito il comando.',
            '#textualplugins [chat]: Sasha mostra una lista di tutti i plugins, se [chat] è specificato permette di modificare la lista del gruppo in cui è stato eseguito il comando.',
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            '#settings: Sasha sends in private an inline keyboard with the group\' settings.',
            '#textualsettings: Sasha sends group settings.',
            '#muteuser|voce <id>|<username>|<reply>|from: Sasha [un]mute the specified user.',
            '(#muteslist|lista muti): Sasha sends in private an inline keyboard with the group\'s mutes.',
            '#textualmuteslist: Sasha sends muted parameters list.',
            ...
            '<setting_type> can be: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict',
            '#settings <group_id>: Sasha sends in private an inline keyboard with <group_id>\'s settings.',
            '#textualsettings <group_id>: Sasha sends <group_id>\'s settings.',
        ...
        help =
        {
            ...
            '(#help|sasha aiuto): Sasha sends in private an inline keyboard of plugins for which there\'s the help.',
            '(#help|sasha aiuto) <plugin_name>|<plugin_number>: Sasha sends in private the help of the specified plugin.',
            '#textualhelp: Sasha sends a list of plugins for which there\'s the help',
            '#textualhelp <plugin_name>|<plugin_number>: Sasha sends the help of the specified plugin.',
