return {
    ...
    it =
    {
        ...
        info =
        {
            ...
            "<code>/trackuser {id}|{username}|{reply}|from [{name}]</code>: Sasha manda un messaggio tramite cui si potrà sempre tracciare {user}.",
            "<b>PM</b>",
    ...
    en =
    {
        ...
        info =
        {
            ...
            "<code>/trackuser {id}|{username}|{reply}|from [{name}]</code>: Sasha sends a message through which you will always be able to track {user}.",
            "<b>PM</b>",
