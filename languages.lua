return {
    ...
    it =
    {
        ...
        groupnoticesDisabled = "Le azioni effettuate sugli utenti verranno eliminate dopo 60 secondi.",
        ...
        administrator =
        {
            ...
            "<b>SUDO</b>",
            "<code>/addadmin {user_id}|{username}</code>: Sasha promuove {user} ad amminstratore.",
            "<code>/removeadmin {user_id}|{username}</code>: Sasha degrada {user}.",
        ...
        banhammer =
        {
            ...
            "<b>MOD</b>",
            "<code>/invite {user}</code>: Sasha manda il link d'invito al{user} se possibile.",
            ...
            "<code>/temprestrict {user} [{weeks} {days} {hours} {minutes} {seconds}] [{restrictions}]</code>: Sasha applica al{user} le limitazioni specificate (se non specificate l'utente avrà di default tutte le limitazioni) per {weeks} {days} {hours} {minutes} {seconds} se specificati, altrimenti manda una tastiera del tempo in privato.",
            "<code>/restrict {user} [{restrictions}]</code>: Sasha applica al{user} le limitazioni specificate (se non specificate l'utente avrà di default tutte le limitazioni applicate).",
        ...
        likecounter =
        {
            ...
            "<b>USER</b>",
            "<code>(/like|/1up) {user}</code>: Sasha aggiunge un like al{user}.",
            "<code>(/dislike|/1down) {user}</code>: Sasha toglie un like al{user}.",
            "<code>/likes</code>: Sasha manda la classifica dei likes.",
            "<b>SUDO</b>",
            "<code>/createlikesdb</code>:  Sasha crea il database di likecounter.",
            "<code>/addlikes {id} {value}</code>: Sasha aggiunge {value} likes al{user}.",
            "<code>/remlikes {id} {value}</code>: Sasha toglie {value} likes al{user}.",
        },
    ...
    en =
    {
        ...
        groupnoticesDisabled = "Actions on users will be deleted after 60 seconds.",
        ...
        administrator =
        {
            ...
            "<b>SUDO</b>",
            "<code>/addadmin {user_id}|{username}</code>: Sasha promotes {user} to administrator.",
            "<code>/removeadmin {user_id}|{username}</code>: Sasha demotes {user} from administrator.",
