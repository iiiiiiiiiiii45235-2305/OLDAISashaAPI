return {
    ...
    it =
    {
        ...
        helpIntro = "Ogni '#' può essere sostituito con i simboli '/' o '!'.\nTutti i comandi sono Case Insensitive.\nLe parentesi quadre significano opzionale (E VANNO RIMOSSE).\nLe parentesi tonde indicano una scelta evidenziata da '|' che significa \"oppure\" (E VANNO RIMOSSE).\n\n",
    ...
    en =
    {
        ...
        helpIntro = "Every '#' can be replaced with '/' or '!'.\nAll commands are Case Insensitive.\nSquare brackets means that is an optional (AND THEY MUST BE REMOVED).\nRound brackets indicate a choice with '|' that means \"or\" (AND THEY MUST BE REMOVED).\n\n",
