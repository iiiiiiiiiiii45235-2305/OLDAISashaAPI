return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            "`/promoteadmin <id>|<username>|<reply>|from [<permissions>]`: Sasha promuove ad amministratore di telegram l'utente specificato con i permessi specificati (se non specificati l'utente avrà tutti i permessi meno che il promote\\_members).",
