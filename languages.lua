return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            '(#unlock|[sasha] sblocca) <group_id> arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha sblocca l\'impostazione specificata di <group_id>.',
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            '(#lock|[sasha] blocca) arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha locks the specified parameter.',
            '(#unlock|[sasha] sblocca) arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha unlocks the specified parameter.',
            'OWNER',
            ...
            '(#unlock|[sasha] sblocca) <group_id> arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict: Sasha unlocks <group_id>\'s the specified setting.',
