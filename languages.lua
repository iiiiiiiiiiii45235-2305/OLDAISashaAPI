return {
    ...
    it =
    {
        ...
        group_management =
        {
            ...
            '(#link|sasha link): Sasha manda un link monouso del gruppo.',
            ...
            '<permissions> può essere: [change_info] [delete_messages] [invite_users] [restrict_users] [pin_messages] [promote_members]',
    ...
    en =
    {
        ...
        group_management =
        {
            ...
            '(#link|sasha link): Sasha sends a monouse link.',
            ...
            '<permissions> can be: [change_info] [delete_messages] [invite_users] [restrict_users] [pin_messages] [promote_members]',
