return {
    ...
    it =
    {
        ...
        administrator =
        {
            ...
            "`/pm <user-id> <msg>`: Sasha invia <msg> a <user-id>.",
            ...
            "`/leave [<group-id>]`: Sasha lascia il gruppo.",
            "SUDO",
            "`/addadmin <user-id>|<username>`: Sasha promuove l'utente specificato ad amminstratore.",
            "`/removeadmin <user-id>|<username>`: Sasha degrada l'utente specificato.",
        ...
        alternatives =
        {
            ...
            "MOD",
            "`/setalternative /<command> <alternative>|<reply-media>`: Sasha eseguirà <alternative>|<reply-media> come se fosse <command>.",
            "`/unsetalternative <alternative>|<reply-media>`: Sasha rimuove <alternative>|<reply-media>.",
            "OWNER",
            ...
            "ADMIN",
            "`/setglobalalternative /<command> <alternative>|<reply-media>`: Sasha eseguirà <alternative>|<reply-media> come se fosse <command> in tutti i gruppi.",
            "`/unsetglobalalternative <alternative>|<reply-media>`: Sasha rimuove <alternative>|<reply-media> dalle alternative globali.",
        ...
        banhammer =
        {
            ...
            "MOD",
            "`/getuserwarns <id>|<username>|<reply>|from`: Sasha manda il numero di avvertimenti ricevuti dall'utente.",
            "`/muteuser <id>|<username>|<reply>|from`: Sasha [s]muta l'utente specificato.",
            ...
            "ADMIN",
            "`/banlist <group-id>`: Sasha mostra la lista di utenti bannati da <group-id>.",
            "`/countbanlist <group-id>`: Sasha manda il numero di utenti bannati da <group-id>.",
        ...
        bot =
        {
            ...
            "ADMIN",
            "`/bot|sasha on|off [<group-id>]`: Sasha si attiva|disattiva nel gruppo specificato.",
        },
        ...
        check_tag =
        {
            ...
            -- "`/tagall <text>|<reply-text>`: Sasha scrive <text>|<reply-text> e tagga tutti i membri del gruppo.",
        },
        ...
        database =
        {
            ...
            "`/addrecord user <id>\n<print-name>\n<old-print-names>\n<username>\n<old-usernames>\n<long-id>\n<groups-ids-separated-by-space>`: Sasha aggiunge manualmente al database l'utente specificato.",
            "`/addrecord group <id>\n<print-name>\n<old-print-names>\n<lang>`: Sasha aggiunge manualmente al database il gruppo specificato.",
            "`/addrecord supergroup <id>\n<print-name>\n<old-print-names>\n<lang>\n[<username>\n<old-usernames>]`: Sasha aggiunge manualmente al database il supergruppo specificato.",
            "`/addrecord channel <id>\n<print-name>\n<old-print-names>\n<lang>\n[<username>\n<old-usernames>]`: Sasha aggiunge manualmente al database il canale specificato.",
        ...
        getsetunset =
        {
            ...
            "USER",
            "`/get <var-name>`: Sasha manda la risposta a <var-name>.",
            ...
            "`/set <var-name>|<pattern> <text>`: Sasha salva <text> come risposta a <var-name>|<pattern>.",
            "`/setmedia <var-name>|<pattern> <reply-media> [<caption>]`: Sasha salva il <reply-media> (foto, video, video messaggio, audio, nota vocale, gif, documento, sticker) come risposta a <var-name>|<pattern>, se <caption> è presente viene usato come didascalia (non disponibile per tutti i media).",
            "`/unset <var-name>|<pattern>`: Sasha elimina <var-name>|<pattern>.",
            "OWNER",
            "`/enableglobal`: Sasha abilita i get globali sulla chat.",
            "`/disableglobal`: Sasha disabilita i get globali sulla chat.",
            "ADMIN",
            "`/setglobal <var-name>|<pattern> <text>`: Sasha salva globalmente <text> come risposta a <var-name>|<pattern>.",
            "`/unsetglobal <var-name>|<pattern>`: Sasha elimina globalmente <var-name>|<pattern>.",
        },
        ...
        goodbyewelcome =
        {
            ...
            "`/setwelcome <text>|(<reply-media> [<caption>])`: Sasha imposta <text>|(<reply-media> [<caption>]) come benvenuto.",
            "`/setgoodbye <text>|(<reply-media> [<caption>])`: Sasha imposta <text>|(<reply-media> [<caption>]) come addio.",
        ...
        group_management =
        {
            ...
            "`/[un]lock <setting-type>`: Sasha [s]blocca <setting-type>.",
            "<setting-type> può essere: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict",
            "`/[un]mute <mute-type>`: Sasha [s]muta <mute-type>.",
            "<mute-type> può essere: audio|contact|document|gif|location|photo|sticker|tgservice|video|video\\_note|voice\\_note",
            "SUPERGROUP",
            ...
            "`/promoteadmin <id>|<username>|<reply>|from [<permissions>]`: Sasha promuove ad amministratore di telegram l'utente specificato con i permessi specificati (se non specificati l'utente avrà di default tutti i permessi meno che il promote-members).",
            ...
            "REGNO",
            "`/setgpowner <group-id> <user-id>`: Sasha imposta <user-id> come proprietario di <group-id>.",
            "`/setrules <group-id> <text>`: Sasha cambia le regole di <group-id> in <text>.",
            "`/[un]mute <group-id> <mute-type>`: Sasha [s]muta <mute-type> in <group-id>.",
            "`/[textual]muteslist <group-id>`: Sasha manda la lista dei muti di <group-id>.",
            "`/[un]lock <group-id> <setting-type>`: Sasha [s]blocca <setting-type> in <group-id>.",
            "`/[textual]settings <group-id>`: Sasha manda le impostazioni di <group-id>.",
            "`/rem <group-id>`: Sasha rimuove il gruppo.",
        },
        ...
        help =
        {
            ...
            "`/[textual]help <plugin-name>|<plugin-number>`: Sasha manda l'aiuto per il plugin specificato.",
        ...
        info =
        {
            ...
            "`/username [<id>|<reply>|from]`: Sasha manda l'username dell'utente/della chat specificato/a, altrimenti l'username dell'utente e l'username del gruppo.",
            "`/getrank [<id>|<username>|<reply>|from]`: Sasha manda il rank dell'utente.",
            ...
            "ADMIN",
            "`/grouplink <group-id>`: Sasha manda il link del gruppo specificato.",
        },
        ...
        interact =
        {
            ...
            "`/[del]upload-photo`: Sasha finge di inviare una foto.",
            "`/[del]record-video`: Sasha finge di registrare un video.",
            "`/[del]upload-video`: Sasha finge di inviare un video.",
            "`/[del]record-audio`: Sasha finge di registrare un audio.",
            "`/[del]upload-audio`: Sasha finge di inviare un audio.",
            "`/[del]upload-document`: Sasha finge di inviare un documento.",
            "`/[del]find-location`: Sasha finge di inviare una posizione.",
            "`/[del]record-videonote`: Sasha finge di registrare un video messaggio.",
            "`/[del]upload-videonote`: Sasha finge di inviare un video messaggio.",
        ...
        qr =
        {
            ...
            "`/qr [\"<background-color>\" \"<data-color>\"] <text>`: Sasha crea il QR Code di <text>, se specificato colora il QR Code.",
        },
        ...
        stats =
        {
            ...
            "ADMIN",
            -- "`(/stats|/messages) group <group-id>`: Sasha invia le statistiche relative al gruppo specificato.",
            "`(/cleanstats|/cleanmessages) group <group-id>`: Sasha pulisce le statistiche relative al gruppo specificato.",
            -- "`(/statslist|/messageslist) group <group-id>`: Sasha invia un file con le statistiche relative al gruppo specificato.",
        },
        ...
        whitelist =
        {
            ...
            "`/whitelistlink <link>|<public-(channel|supergroup)-username>|<channel-id>`: Sasha aggiunge|rimuove <link>|<public-(channel|supergroup)-username>|<channel-id> alla|dalla whitelist dei link.",
        },
    },
    -- ####
    en =
    {
        ...
        administrator =
        {
            ...
            "`/pm <user-id> <msg>`: Sasha writes <msg> to <user-id>.",
            ...
            "`/leave [<group-id>]`: Sasha leaves the group.",
            "SUDO",
            "`/addadmin <user-id>|<username>`: Sasha promotes the specified user to administrator.",
            "`/removeadmin <user-id>|<username>`: Sasha demotes the specified user from administrator.",
            "`/botstop`: Sasha stops.",
        ...
        alternatives =
        {
            ...
            "MOD",
            "`/setalternative /<command> <alternative>|<reply-media>`: Sasha will execute <alternative>|<reply-media> as if it was <command>.",
            "`/unsetalternative <alternative>|<reply-media>`: Sasha deletes <alternative>|<reply-media>.",
            "OWNER",
            ...
            "ADMIN",
            "`/setglobalalternative /<command> <alternative>|<reply-media>`: Sasha will execute <alternative>|<reply-media> as if it was <command> in all groups.",
            "`/unsetglobalalternative <alternative><reply-media>`: Sasha deletes <alternative>|<reply-media> from global alternatives.",
        ...
        banhammer =
        {
            ...
            "MOD",
            "`/getuserwarns <id>|<username>|<reply>|from`: Sasha sends user's warns.",
            "`/muteuser <id>|<username>|<reply>|from`: Sasha [un]mutes the specified user.",
            ...
            "ADMIN",
            "`/banlist <group-id>`: Sasha sends bans list of <group-id>.",
            "`/countbanlist <group-id>`: Sasha sends the number of banned users of <group-id>.",
        ...
        bot =
        {
            ...
            "ADMIN",
            "`/bot|sasha on|off [<group-id>]`: Sasha goes on|off in the specified group.",
        },
        ...
        check_tag =
        {
            ...
            -- "`/tagall <text>|<reply-text>`: Sasha writes <text>|<reply-text> tags all group's members.",
        },
        ...
        database =
        {
            ...
            "`/addrecord user <id>\n<print-name>\n<old-print-names>\n<username>\n<old-usernames>\n<long-id>\n<groups-ids-separated-by-space>`: Sasha manually adds the specified user to the database.",
            "`/addrecord group <id>\n<print-name>\n<old-print-names>\n<lang>`: Sasha manually adds the specified group to the database.",
            "`/addrecord supergroup <id>\n<print-name>\n<old-print-names>\n<lang>\n[<username>\n<old-usernames>]`: Sasha manually adds the specified supergroup to the database.",
            "`/addrecord channel <id>\n<print-name>\n<old-print-names>\n<lang>\n[<username>\n<old-usernames>]`: Sasha manually adds the specified channel to the database.",
        ...
        getsetunset =
        {
            ...
            "USER",
            "`/get <var-name>`: Sasha sends the answer to <var-name>.",
            ...
            "`/set <var-name>|<pattern> <text>`: Sasha saves <text> as answer to <var-name>|<pattern>.",
            "`/setmedia <var-name>|<pattern> <reply-media> [<caption>]`: Sasha saves <reply-media> (photo, video, video message, audio, voice note, gif, document, sticker) as answer to <var-name>|<pattern>, if <caption> is present it will be sent as caption (not available for all media).",
            "`/unset <var-name>|<pattern>`: Sasha deletes <var-name>|<pattern>.",
            "OWNER",
            "`/enableglobal`: Sasha enables global gets on chat.",
            "`/disableglobal`: Sasha disables global gets on chat.",
            "ADMIN",
            "`/setglobal <var-name>|<pattern> <text>`: Sasha globally saves <text> as answer to <var-name>|<pattern>.",
            "`/unsetglobal <var-name>|<pattern>`: Sasha globally deletes <var-name>|<pattern>.",
        },
        ...
        goodbyewelcome =
        {
            ...
            "`/setwelcome <text>|(<reply-media> [<caption>])`: Sasha sets <text>|(<reply-media> [<caption>]) as welcome.",
            "`/setgoodbye <text>|(<reply-media> [<caption>])`: Sasha sets <text>|(<reply-media> [<caption>]) as goodbye.",
        ...
        group_management =
        {
            ...
            "`/[un]lock <setting-type>`: Sasha [un]locks <setting-type>.",
            "<setting-type> can be: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict",
            "`/[un]mute <mute-type>`: Sasha [un]mutes the specified parameter.",
            "<mute-type> can be: audio|contact|document|gif|location|photo|sticker|tgservice|video|video\\_note|voice\\_note",
            "SUPERGROUP",
            ...
            "REALM",
            "`/setgpowner <group-id> <user-id>`: Sasha sets <user-id> as owner of <group-id>.",
            "`/setrules <group-id> <text>`: Sasha changes <group-id>'s rules with <text>.",
            "`/[un]mute <group-id> <mute-type>`: Sasha [un]mutes <group-id>'s <mute-type>.",
            "`/[textual]muteslist <group-id>`: Sasha sends <group-id>'s mutes.",
            "`/[un]lock <group-id> <setting-type>`: Sasha [un]locks <group-id>'s <setting-type>.",
            "`/[textual]settings <group-id>`: Sasha sends <group-id>'s settings.",
            "`/rem <group-id>`: Sasha removes group.",
        },
        ...
        help =
        {
            ...
            "`/[textual]help <plugin-name>|<plugin-number>`: Sasha sends the help of the specified plugin.",
        ...
        info =
        {
            ...
            "`/username [<id>|<reply>|from]`: Sasha sends the username of the specified user/chat, otherwise the username of the user and the username of the chat.",
            "`/getrank [<id>|<username>|<reply>|from]`: Sasha sends the rank of the specified user.",
            ...
            "ADMIN",
            "`/grouplink <group-id>`: Sasha sends link of the specified group.",
        },
        ...
        interact =
        {
            ...
            "`/[del]upload-photo`: Sasha pretends to upload a photo.",
            "`/[del]record-video`: Sasha pretends to record a video.",
            "`/[del]upload-video`: Sasha pretends to upload a video.",
            "`/[del]record-audio`: Sasha pretends to record an audio.",
            "`/[del]upload-audio`: Sasha pretends to upload an audio.",
            "`/[del]upload-document`: Sasha pretends to upload a document.",
            "`/[del]find-location`: Sasha pretends to send a location.",
            "`/[del]record-videonote`: Sasha pretends to record a video message.",
            "`/[del]upload-videonote`: Sasha pretends to upload a video message.",
        ...
        likecounter =
        {
            ...
            "`(/dislike|/1down) <id>|<username>|<reply>|from`: Sasha removes a like from the specified user.",
        ...
        qr =
        {
            ...
            "`/qr [\"<background-color>\" \"<data-color>\"] <text>`: Sasha creates QR Code of <text>, if the specified it colors QR Code.",
        },
        ...
        stats =
        {
            ...
            "ADMIN",
            -- "`(/stats|/messages) group <group-id>`: Sasha sends <group-id>'s stats.",
            "`(/cleanstats|/cleanmessages) group <group-id>`: Sasha cleans <group-id>'s stats.",
            -- "`(/statslist|/messageslist) group <group-id>`: Sasha sends file with <group-id>'s stats.",
        },
        ...
        whitelist =
        {
            ...
            "`/whitelistlink <link>|<public-(channel|supergroup)-username>|<channel-id>`: adds|removes <link>|<public-(channel|supergroup)-username>|<channel-id> to/from the links' whitelist.",
        },
    },
}