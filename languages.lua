return {
    ...
    it =
    {
        ...
        sendFAQPvt = "Ti ho mandato le FAQ in privato.",
        ...
        mutesOf = "Muti di ",
        sendSettingsPvt = "Ti ho mandato le impostazioni in privato.",
        sendMutesPvt = "Ti ho mandato i muti in privato.",
        -- ex common --
        ...
        administrator =
        {
            ...
            "`/pm <user_id> <msg>`: Sasha invia <msg> a <user\\_id>.",
            "`/pmblock <user>`: Sasha blocca l'utente specificato.",
            "`/pmunblock <user>`: Sasha sblocca l'utente specificato.",
            ...
            "`/requestslog`: Sasha manda il log delle richieste API.",
        ...
        alternatives =
        {
            ...
            "MOD",
            "`/setalternative /<command> <alternative>|<reply_media>`: Sasha eseguirà <alternative>|<reply\\_media> come se fosse <command>.",
            "`/unsetalternative <alternative>|<reply_media>`: Sasha rimuove <alternative>|<reply\\_media>.",
            "OWNER",
            ...
            "ADMIN",
            "`/setglobalalternative /<command> <alternative>|<reply_media>`: Sasha eseguirà <alternative>|<reply\\_media> come se fosse <command> in tutti i gruppi.",
            "`/unsetglobalalternative <alternative>|<reply_media>`: Sasha rimuove <alternative>|<reply\\_media> dalle alternative globali.",
        ...
        banhammer =
        {
            ...
            "MOD",
            "`/getuserwarns <user>`: Sasha manda il numero di avvertimenti ricevuti dall'utente.",
            "`/muteuser <user>`: Sasha [s]muta l'utente specificato.",
            "`/mutelist`: Sasha manda la lista degli utenti muti della chat.",
            "`/warn <user> [<reason>]`: Sasha avverte l'utente.",
            "`/unwarn <user> [<reason>]`: Sasha diminuisce di uno gli avvertimenti dell'utente.",
            "`/unwarnall <user> [<reason>]`: Sasha azzera gli avvertimenti dell'utente.",
            "`/temprestrict <user> [<weeks> <days> <hours> <minutes> <seconds>] [<restrictions>]`: Sasha applica all'utente specificato le restrizioni specificate (se non specificate l'utente avrà di default tutte le restrizioni applicate) per <weeks> <days> <hours> <minutes> <seconds> se specificati, altrimenti manda una tastiera del tempo in privato.",
            "`/restrict <user> [<restrictions>]`: Sasha applica all'utente specificato le restrizioni specificate (se non specificate l'utente avrà di default tutte le restrizioni applicate).",
            "<restrictions> può essere: [send\\_messages] [send\\_media\\_messages] [send\\_other\\_messages] [add\\_web\\_page\\_previews]",
            "`/unrestrict <user>`: Sasha rimuove le restrizioni dell'utente specificato.",
            "`/[textual]restrictions <user>`: Sasha manda le restrizioni dell'utente specificato.",
            "`/kick <user> [<reason>]`: Sasha kicka l'utente specificato.",
            "`/tempban <user> [<weeks> <days> <hours> <minutes> <seconds>] [<reason>]`: Sasha banna l'utente specificato per <weeks> <days> <hours> <minutes> <seconds> se specificati, altrimenti manda una tastiera del tempo in privato.",
            "`/ban <user> [<reason>]`: Sasha banna l'utente specificato e lo kicka, se tentasse di rientrare verrebbe nuovamente kickato.",
            "`/unban <user> [<reason>]`: Sasha sbanna l'utente specificato.",
            ...
            "ADMIN",
            "`/banlist <group_id>`: Sasha mostra la lista di utenti bannati da <group\\_id>.",
            "`/countbanlist <group_id>`: Sasha manda il numero di utenti bannati da <group\\_id>.",
            "`/gban <user>`: Sasha banna globalmente l'utente specificato e lo kicka, se tentasse di rientrare verrebbe nuovamente kickato.",
            "`/ungban <user>`: Sasha sbanna globalmente l'utente specificato.",
        ...
        bot =
        {
            ...
            "USER",
            "`/start`: Sasha manda il messaggio di start.",
            "`/del <reply>`: Sasha elimina il messaggio in <reply> (funziona solo in chat privata).",
            "`/delkeyboard <reply>`: Sasha elimina la keyboard in <reply> (funziona solo in chat privata).",
            "OWNER",
        ...
        check_tag =
        {
            ...
            -- "`/tagall <text>|<reply_text>`: Sasha scrive <text>|<reply\\_text> e tagga tutti i membri del gruppo.",
        },
        ...
        database =
        {
            ...
            "`/dbsearch <id>|<username>|<reply>|from`: Sasha cerca l'oggetto specificato nel database.",
            "`/dbdelete <id>`: Sasha elimina <id> dal database.",
            "`/addrecord user <id>\n<print_name>\n<old_print_names>\n<username>\n<old_usernames>\n<long_id>\n<groups_ids_separated_by_spaces>`: Sasha aggiunge manualmente al database l'utente specificato.",
        ...
        flame =
        {
            ...
            "MOD",
            "`/startflame <user>`: Sasha flamma l'utente specificato.",
            "`/stopflame`: Sasha smette di flammare.",
            "`/flameinfo`: Sasha manda le info su chi sta flammando.",
        },
        ...
        getsetunset =
        {
            ...
            "USER",
            "`/get <var_name>`: Sasha manda la risposta a <var\\_name>.",
            ...
            "`/set <var_name>|<pattern> <text>`: Sasha salva <text> come risposta a <var\\_name>|<pattern>.",
            "`/setmedia <var_name>|<pattern> <reply_media> [<caption>]`: Sasha salva il <reply\\_media> (foto, video, video messaggio, audio, nota vocale, gif, documento, sticker) come risposta a <var\\_name>|<pattern>, se <caption> è presente viene usato come didascalia (non disponibile per tutti i media).",
            "`/unset <var_name>|<pattern>`: Sasha elimina <var\\_name>|<pattern>.",
            "OWNER",
            "`/enableglobal`: Sasha abilita i get globali sulla chat.",
            "`/disableglobal`: Sasha disabilita i get globali sulla chat.",
            "ADMIN",
            "`/setglobal <var_name>|<pattern> <text>`: Sasha salva globalmente <text> come risposta a <var\\_name>|<pattern>.",
            "`/unsetglobal <var_name>|<pattern>`: Sasha elimina globalmente <var\\_name>|<pattern>.",
        },
        ...
        goodbyewelcome =
        {
            ...
            "`/setwelcome <text>|(<reply_media> [<caption>])`: Sasha imposta <text>|(<reply\\_media> [<caption>]) come benvenuto.",
            "`/setgoodbye <text>|(<reply_media> [<caption>])`: Sasha imposta <text>|(<reply\\_media> [<caption>]) come addio.",
        ...
        group_management =
        {
            ...
            "`/rules`: Sasha mostra le regole del gruppo.",
            "`/modlist`: Sasha mostra la lista dei moderatori.",
            "`/owner`: Sasha mostra l'id del proprietario del gruppo.",
            "`/admins [<reply>|<text>]`: Sasha contatta gli admin",
            "`/link`: Sasha manda il link del gruppo, se permesso dai moderatori.",
            "`/[textual]settings`: Sasha manda le impostazioni del gruppo.",
            ...
            "`/[un]lock <setting>`: Sasha [s]blocca <setting>.",
            "<setting> può essere: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict",
            "`/[un]mute <mute>`: Sasha [s]muta <mute>.",
            "<mute> può essere: all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video\\_note|voice\\_note",
            "SUPERGROUP",
            "`/[silent]pin <reply>`: Sasha fissa [silenziosamente] <reply>.",
            "`/unpin`: Sasha stacca il messaggio fissato.",
            "`/settitle <text>`: Sasha imposta <text> come titolo del gruppo.",
            "`/setdescription <text>`: Sasha imposta <text> come descrizione del gruppo.",
            "`/setphoto <reply>`: Sasha imposta <reply> come foto del gruppo.",
            "`/unsetphoto`: Sasha elimina la foto del gruppo.",
            "OWNER",
            "`/syncmodlist`: Sasha sincronizza i moderatori con gli amministratori di telegram.",
            "`/log`: Sasha manda un file contenente il log giornaliero della chat.",
            "`/setlink <link>`: Sasha imposta <link> come link d'invito.",
            "`/unsetlink`: Sasha elimina il link salvato.",
            "`/getadmins`: Sasha manda la lista degli amministratori.",
            "`/[textual]permissions <user>`: Sasha manda i permessi dell'utente specificato.",
            "`/promote <user>`: Sasha promuove a moderatore l'utente specificato.",
            "`/demote <user>`: Sasha degrada l'utente specificato.",
            "`/promoteadmin <user> [<permissions>]`: Sasha promuove ad amministratore di telegram l'utente specificato con i permessi specificati (se non specificati l'utente avrà tutti i permessi meno che il promote\\_members).",
            "<permissions> può essere: [change\\_info] [delete\\_messages] [invite\\_users] [restrict\\_members] [pin\\_messages] [promote\\_members]",
            "`/demoteadmin <user>`: Sasha degrada da amministratore di telegram l'utente specificato.",
            "`/setowner <user>`: Sasha imposta l'utente specificato come proprietario.",
            ...
            "REGNO",
            "`/setgpowner <group_id> <user_id>`: Sasha imposta <user\\_id> come proprietario di <group\\_id>.",
            "`/setrules <group_id> <text>`: Sasha cambia le regole di <group\\_id> in <text>.",
            "`/[un]mute <group_id> <mute>`: Sasha [s]muta <mute> in <group\\_id>.",
            "`/[textual]muteslist <group_id>`: Sasha manda la lista dei muti di <group\\_id>.",
            "`/[un]lock <group_id> <setting>`: Sasha [s]blocca <setting> in <group\\_id>.",
            "`/[textual]settings <group_id>`: Sasha manda le impostazioni di <group\\_id>.",
        ...
        info =
        {
            ...
            "USER",
            "`/id [<user>]`: Sasha manda l'id dell'utente/della chat specificato/a, altrimenti l'id dell'utente e l'id del gruppo.",
            "`/username [<user>]`: Sasha manda l'username dell'utente/della chat specificato/a, altrimenti l'username dell'utente e l'username del gruppo.",
            "`/getrank [<user>]`: Sasha manda il rank dell'utente.",
            "`/whoami`: Sasha manda le informazioni dell'utente.",
            "`/info`: Sasha manda le info dell'utente e della chat o di se stessa",
            "`/ishere <user>`: Sasha dice se l'utente specificato è presente nel gruppo.",
            "MOD",
            "`/info <id>|<username>|<reply>|from`: Sasha manda le info dell'oggetto specificato.",
        ...
        interact =
        {
            ...
            "`/testobject <id>|<username>|<reply>|from`: Sasha controlla se può scrivere all'oggetto specificato.",
            "MOD",
        ...
        likecounter =
        {
            ...
            "USER",
            "`(/like|/1up) <user>`: Sasha aggiunge un like all'utente specificato.",
            "`(/dislike|/1down) <user>`: Sasha toglie un like all'utente specificato.",
        ...
        multiple_commands =
        {
            ...
            "`/multipleusername <id1> <id2> ...`: Sasha manda gli username di tutti gli <ids> specificati nella lista.",
            "`/multipleishere <user1> <user2> ...`: Sasha controlla se gli <users> specificati nella lista sono nel gruppo.",
            "`/multiplegetrank <user1> <user2> ...`: Sasha manda il rango di tutti gli <users> specificati nella lista.",
            "`/multipleinfo <obj1> <obj2> ...`: Sasha manda le info di tutti gli <objects> specificati nella lista.",
            "`/multiplegetuserwarns <user1> <user2> ...`: Sasha manda gli avvertimenti di tutti gli <users> specificati nella lista.",
            "`/multiplemuteuser <user1> <user2> ...`: Sasha [s]muta tutti gli <users> specificati nella lista.",
            "OWNER",
            "`/multiplewarn <user1> <user2> ...`: Sasha avverte tutti gli <users> specificati nella lista.",
            "`/multipleunwarn <user1> <user2> ...`: Sasha diminuisce di uno gli avvertimenti di tutti gli <users> specificati nella lista.",
            "`/multipleunwarnall <user1> <user2> ...`: Sasha azzera gli avvertimenti di tutti gli <users> specificati nella lista.",
            "`/multiplekick <user1> <user2> ...`: Sasha kicka tutti gli <users> specificati nella lista.",
            "`/multipleban <user1> <user2> ...`: Sasha banna tutti gli <users> specificati nella lista.",
            "`/multipleunban <user1> <user2> ...`: Sasha sbanna tutti gli <users> specificati nella lista.",
            "SUDO",
            "`/multipledbsearch <obj1> <obj2> ...`: Sasha cerca nel database tutti gli <objects> specificati nella lista.",
            "`/multipledbdelete <obj1> <obj2> ...`: Sasha elimina dal database tutti gli <objects> specificati nella lista.",
            "`/multiplegrouplink <group1> <group2> ...`: Sasha invia il link di tutti i <groups> specificati nella lista.",
            "`/multiplepmblock <user1> <user2> ...`: Sasha blocca tutti gli <users> specificati nella lista.",
            "`/multiplepmunblock <user1> <user2> ...`: Sasha sblocca tutti gli <users> specificati nella lista.",
            "`/multiplegban <user1> <user2> ...`: Sasha banna globalmente tutti gli <users> specificati nella lista.",
            "`/multipleungban <user1> <user2> ...`: Sasha sbanna globalmente tutti gli <users> specificati nella lista.",
        },
        ...
        plugins =
        {
            ...
            "`/disabledlist`: Sasha mostra una lista dei plugins disabilitati su questa chat.",
            "`/enable <plugin> chat`: Sasha riabilita <plugin> su questa chat.",
            "`/disable <plugin> chat`: Sasha disabilita <plugin> su questa chat.",
            "SUDO",
            "`/[textual]plugins [chat]`: Sasha manda la lista dei plugin, se [chat] è specificato permette di modificare la lista del gruppo in cui è stato eseguito il comando.",
            "`/enable <plugin> [chat]`: Sasha abilita <plugin>, se specificato solo su questa chat.",
            "`/disable <plugin> [chat]`: Sasha disabilita <plugin>, se specificato solo su questa chat.",
            "`/reload`: Sasha ricarica tutti i plugins.",
            "`/reloadbot`: Sasha ricarica se stessa.",
        },
        ...
        whitelist =
        {
            ...
            "`/whitelistlink`: Sasha manda la whitelist dei link.",
            "OWNER",
            "`/whitelist <user>`: Sasha aggiunge|rimuove l'utente specificato alla|dalla whitelist.",
            "`/whitelistgban <user>`: Sasha aggiunge|rimuove l'utente specificato alla|dalla whitelist dei gban.",
            "`/whitelistlink <link>|<public_(channel|supergroup)_username>|<channel_id>`: Sasha aggiunge|rimuove <link>|<public\\_(channel|supergroup)\\_username>|<channel\\_id> alla|dalla whitelist dei link.",
        },
    },
    -- ####
    en =
    {
        ...
        mutesOf = "Mutes of ",
        sendSettingsPvt = "I've sent you the settings in private.",
        sendMutesPvt = "I've sent you the mutes in private.",
        -- ex common --
        ...
        administrator =
        {
            ...
            "`/pm <user_id> <msg>`: Sasha writes <msg> to <user\\_id>.",
            "`/pmblock <user>`: Sasha blocks the specified user.",
            "`/pmunblock <user>`: Sasha unblocks the specified user.",
            ...
            "`/requestslog`: Sasha sends the log of API requests.",
        ...
        alternatives =
        {
            ...
            "MOD",
            "`/setalternative /<command> <alternative>|<reply_media>`: Sasha will execute <alternative>|<reply\\_media> as if it was <command>.",
            "`/unsetalternative <alternative>|<reply_media>`: Sasha deletes <alternative>|<reply\\_media>.",
            "OWNER",
            ...
            "ADMIN",
            "`/setglobalalternative /<command> <alternative>|<reply_media>`: Sasha will execute <alternative>|<reply\\_media> as if it was <command> in all groups.",
            "`/unsetglobalalternative <alternative><reply_media>`: Sasha deletes <alternative>|<reply\\_media> from global alternatives.",
        ...
        banhammer =
        {
            ...
            "MOD",
            "`/getuserwarns <user>`: Sasha sends user's warns.",
            "`/muteuser <user>`: Sasha [un]mutes the specified user.",
            "`/mutelist`: Sasha sends muted users' list.",
            "`/warn <user> [<reason>]`: Sasha warns the specified user.",
            "`/unwarn <user> [<reason>]`: Sasha removes one warn from the specified user.",
            "`/unwarnall <user> [<reason>]`: Sasha removes all warns from the specified user.",
            "`/temprestrict <user> [<weeks> <days> <hours> <minutes> <seconds>] [<restrictions>]`: Sasha restrict the specified user as specified (if not specified the user will have all the restrictions) for <weeks> <days> <hours> <minutes> <seconds> if specified, otherwise she sends a time keyboard in private.",
            "`/restrict <user> [<restrictions>]`: Sasha restrict the specified user as specified (if not specified the user will have all the restrictions).",
            "<restrictions> can be: [send\\_messages] [send\\_media\\_messages] [send\\_other\\_messages] [add\\_web\\_page\\_previews]",
            "`/unrestrict <user> [<reason>]`: Sasha unrestrict the specified user.",
            "`/[textual]restrictions <user>`: Sasha sends an inline keyboard with the restrictions of the specified user.",
            "`/kick <user> [<reason>]`: Sasha kicks the specified user.",
            "`/tempban <user> [<weeks> <days> <hours> <minutes> <seconds>] [<reason>]`: Sasha kicks and bans the specified user for <weeks> <days> <hours> <minutes> <seconds> if specified, otherwise she sends a time keyboard in private.",
            "`/ban <user> [<reason>]`: Sasha kicks and bans the specified user, if he tries to join again it's automatically kicked.",
            "`/unban <user> [<reason>]`: Sasha unbans the specified user.",
            ...
            "ADMIN",
            "`/banlist <group_id>`: Sasha sends bans list of <group\\_id>.",
            "`/countbanlist <group_id>`: Sasha sends the number of banned users of <group\\_id>.",
            "`/gban <user>`: Sasha kicks and gbans the specified user, if he tries to join again it's automatically kicked.",
            "`/ungban <user>`: Sasha ungbans the specified user.",
        ...
        bot =
        {
            ...
            "USER",
            "`/start`: Sasha sends the start message (works only in private chat).",
            "`/del <reply>`: Sasha deletes the message in <reply> (works only in private chat).",
            "`/delkeyboard <reply>`: Sasha deletes the keyboard in <reply> (works only in private chat).",
            "OWNER",
        ...
        check_tag =
        {
            ...
            -- "`/tagall <text>|<reply_text>`: Sasha writes <text>|<reply\\_text> tags all group's members.",
        },
        ...
        database =
        {
            ...
            "`/dbsearch <id>|<username>|<reply>|from`: Sasha searches for the specified object in the database.",
            "`/dbdelete <id>`: Sasha deleted <id> from the database.",
            "`/addrecord user <id>\n<print_name>\n<old_print_names>\n<username>\n<old_usernames>\n<long_id>\n<groups_ids_separated_by_spaces>`: Sasha manually adds the specified user to the database.",
        ...
        filemanager =
        {
            ...
            "`/cd [<directory>]`: Sasha enters in <directory>, if it's not the specified it returns to base folder.",
        ...
        flame =
        {
            ...
            "MOD",
            "`/startflame <user>`: Sasha flames the specified user.",
            "`/stopflame`: Sasha stops flame.",
            "`/flameinfo`: Sasha sends flamed user info.",
        },
        ...
        getsetunset =
        {
            ...
            "USER",
            "`/get <var_name>`: Sasha sends the answer to <var\\_name>.",
            ...
            "`/set <var_name>|<pattern> <text>`: Sasha saves <text> as answer to <var\\_name>|<pattern>.",
            "`/setmedia <var_name>|<pattern> <reply_media> [<caption>]`: Sasha saves <reply\\_media> (photo, video, video message, audio, voice note, gif, document, sticker) as answer to <var\\_name>|<pattern>, if <caption> is present it will be sent as caption (not available for all media).",
            "`/unset <var_name>|<pattern>`: Sasha deletes <var\\_name>|<pattern>.",
            "OWNER",
            "`/enableglobal`: Sasha enables global gets on chat.",
            "`/disableglobal`: Sasha disables global gets on chat.",
            "ADMIN",
            "`/setglobal <var_name>|<pattern> <text>`: Sasha globally saves <text> as answer to <var\\_name>|<pattern>.",
            "`/unsetglobal <var_name>|<pattern>`: Sasha globally deletes <var\\_name>|<pattern>.",
        },
        ...
        goodbyewelcome =
        {
            ...
            "`/setwelcome <text>|(<reply_media> [<caption>])`: Sasha sets <text>|(<reply\\_media> [<caption>]) as welcome.",
            "`/setgoodbye <text>|(<reply_media> [<caption>])`: Sasha sets <text>|(<reply\\_media> [<caption>]) as goodbye.",
        ...
        group_management =
        {
            ...
            "`/rules`: Sasha sends group's rules.",
            "`/modlist`: Sasha sends moderators list.",
            "`/owner`: Sasha sends owner's id.",
            "`/admins [<reply>|<text>]`: Sasha contacts admins",
            "`/link`: Sasha sends the link of the group, if allowed by the mods.",
            "`/[textual]settings`: Sasha sends group's settings.",
            ...
            "`/[un]lock <setting>`: Sasha [un]locks <setting>.",
            "<setting> can be: arabic|bots|flood|grouplink|leave|link|member|rtl|spam|strict",
            "`/[un]mute <mute>`: Sasha [un]mutes the specified parameter.",
            "<mute> can be: all|audio|contact|document|gif|location|photo|sticker|text|tgservice|video|video\\_note|voice\\_note",
            "SUPERGROUP",
            "`/[silent]pin <reply>`: Sasha [silently] pins <reply>.",
            "`/unpin`: Sasha unpins the pinned message.",
            "`/settitle <text>`: Sasha sets <text> as the group's title.",
            "`/setdescription <text>`: Sasha sets <text> as the group's description.",
            "`/setphoto <reply>`: Sasha sets <reply> as the group's photo.",
            "`/unsetphoto`: Sasha deletes the group's photo.",
            "OWNER",
            "`/syncmodlist`: Sasha syncs the modlist with telegram's adminstrators.",
            "`/log`: Sasha sends a file that contains the daily log of the chat.",
            "`/setlink <link>`: Sasha saves <link> as group's link.",
            "`/unsetlink`: Sasha deletes the saved link.",
            "`/[textual]permissions <user>`: Sasha sends the permissions of the specified user.",
            "`/promote <user>`: Sasha promotes to mod the specified user.",
            "`/demote <user>`: Sasha demotes from mod the specified user.",
            "`/promoteadmin <user> [<permissions>]`: Sasha promotes to telegram administrator the specified user with the specified permissions (if not specified the user will have all the permissions but promote\\_members).",
            "<permissions> can be: [change\\_info] [delete\\_messages] [invite\\_users] [restrict\\_members] [pin\\_messages] [promote\\_members]",
            "`/demoteadmin <user>`: Sasha demotes from telegram administrator the specified user.",
            "`/setowner <user>`: Sasha sets the specified user as owner.",
            ...
            "REALM",
            "`/setgpowner <group_id> <user_id>`: Sasha sets <user\\_id> as owner of <group\\_id>.",
            "`/setrules <group_id> <text>`: Sasha changes <group\\_id>'s rules with <text>.",
            "`/[un]mute <group_id> <mute>`: Sasha [un]mutes <group\\_id>'s <mute>.",
            "`/[textual]muteslist <group_id>`: Sasha sends <group\\_id>'s mutes.",
            "`/[un]lock <group_id> <setting>`: Sasha [un]locks <group\\_id>'s <setting>.",
            "`/[textual]settings <group_id>`: Sasha sends <group\\_id>'s settings.",
        ...
        info =
        {
            ...
            "USER",
            "`/id [<user>]`: Sasha sends the id of the specified user/chat, otherwise the id of the user and the id of the chat.",
            "`/username [<user>]`: Sasha sends the username of the specified user/chat, otherwise the username of the user and the username of the chat.",
            "`/getrank [<user>]`: Sasha sends the rank of the specified user.",
            "`/whoami`: Sasha sends user's info.",
            "`/info`: Sasha sends user's info and chat's info or her info.",
            "`/ishere <user>`: Sasha says if the specified user is in the group.",
            "MOD",
            "`/info <id>|<username>|<reply>|from`: Sasha sends info of the specified object.",
        ...
        interact =
        {
            ...
            "`/testobject <id>|<username>|<reply>|from`: Sasha tests if she can write to the specified object.",
            "MOD",
        ...
        likecounter =
        {
            ...
            "USER",
            "`(/like|/1up) <user>`: Sasha adds a like to the specified user.",
            "`(/dislike|/1down) <user>`: Sasha removes a like from the specified user.",
            "`/likes`: Sasha sends the likes leaderboard.",
            "SUDO",
            "`/createlikesdb`:  Sasha creates likecounter database.",
            "`/addlikes <id> <value>`: Sasha adds <value> likes to the specified user.",
            "`/remlikes <id> <value>`: Sasha removes <value> likes to the specified user.",
        },
        ...
        multiple_commands =
        {
            ...
            "`/multipleusername <id1> <id2> ...`: Sasha sends the username of all the <ids> in the list.",
            "`/multipleishere <user1> <user2> ...`: Sasha checks if all the <users> in the list are in the group.",
            "`/multiplegetrank <user1> <user2> ...`: Sasha sends the rank of all the <users> in the list.",
            "`/multipleinfo <obj1> <obj2> ...`: Sasha sends the info of all the <objects> in the list.",
            "`/multiplegetuserwarns <user1> <user2> ...`: Sasha sends the warns of all the <users> in the list.",
            "`/multiplemuteuser <user1> <user2> ...`: Sasha [un]mutes all the <users> in the list.",
            "OWNER",
            "`/multiplewarn <user1> <user2> ...`: Sasha warns all the <users> in the list.",
            "`/multipleunwarn <user1> <user2> ...`: Sasha removes one warns from all the <users> in the list.",
            "`/multipleunwarnall <user1> <user2> ...`: Sasha removes all warns from all the <users> in the list.",
            "`/multiplekick <user1> <user2> ...`: Sasha kicks all the <users> in the list.",
            "`/multipleban <user1> <user2> ...`: Sasha bans all the <users> in the list.",
            "`/multipleunban <user1> <user2> ...`: Sasha unbans all the <users> in the list.",
            "SUDO",
            "`/multipledbsearch <obj1> <obj2> ...`: Sasha search through the database all the <objects> in the list.",
            "`/multipledbdelete <obj1> <obj2> ...`: Sasha deletes from the database all the <objects> in the list.",
            "`/multiplegrouplink <group1> <group2> ...`: Sasha sends the link of all the <groups> in the list.",
            "`/multiplepmblock <user1> <user2> ...`: Sasha blocks all the <users> in the list.",
            "`/multiplepmunblock <user1> <user2> ...`: Sasha unblocks all the <users> in the list.",
            "`/multiplegban <user1> <user2> ...`: Sasha gbans all the <users> in the list.",
            "`/multipleungban <user1> <user2> ...`: Sasha ungbans all the <users> in the list.",
        },
        ...
        plugins =
        {
            ...
            "`/disabledlist`: Sasha sends disabled plugins list.",
            "`/enable <plugin> chat`: Sasha re enables <plugin> on this chat.",
            "`/disable <plugin> chat`: Sasha disables <plugin> on this chat.",
            "SUDO",
            "`/[textual]plugins [chat]`: Sasha sends a list of plugins, if [chat] is specified it allows to manage the plugins' list of the group in which the command was executed.",
            "`/enable <plugin> [chat]`: Sasha enables <plugin>, if the specified just on chat.",
            "`/disable <plugin> [chat]`: Sasha disables <plugin>, if the specified just on chat.",
            "`/reload`: Sasha reloads all plugins.",
            "`/reloadbot`: Sasha reloads itself.",
        },
        ...
        stats =
        {
            ...
            "ADMIN",
            -- "`(/stats|/messages) group <group_id>`: Sasha sends <group\\_id>'s stats.",
            "`(/cleanstats|/cleanmessages) group <group_id>`: Sasha cleans <group\\_id>'s stats.",
            -- "`(/statslist|/messageslist) group <group_id>`: Sasha sends file with <group\\_id>'s stats.",
        },
        ...
        whitelist =
        {
            ...
            "`/whitelistlink`: Sasha sends the links whitelist.",
            "OWNER",
            "`/whitelist <user>`: adds|removes the specified user to|from the whitelist.",
            "`/whitelistgban <user>`: adds|removes the specified user to|from the gban whitelist.",
            "`/whitelistlink <link>|<public_(channel|supergroup)_username>|<channel_id>`: adds|removes <link>|<public\\_(channel|supergroup)\\_username>|<channel\\_id> to/from the links' whitelist.",
        },
    },
}