return {
    ...
    it =
    {
        ...
        banhammer =
        {
            ...
            'USER',
            '(#kickme|sasha (uccidimi|esplodimi|sparami|decompilami|bannami)): Sasha kicka l\'utente.',
            'MOD',
            ...
            '(#warn|sasha avverti) <id>|<username>|<reply>|from [<reason>]: Sasha avverte l\'utente.',
        ...
        group_management =
        {
            ...
            '(#link|sasha link): Sasha manda il link del gruppo.',
            'MOD',
            ...
            '(#newlink|sasha crea link): Sasha crea un link per il gruppo.',
            ...
            '(#[textual]muteslist|lista muti): Sasha manda la lista dei muti della chat.',
            ...
            '(#lock|[sasha] blocca) <setting_type>: Sasha blocca <setting_type>.',
            '(#unlock|[sasha] sblocca) <setting_type>: Sasha sblocca <setting_type>.',
            ...
            '#mute|silenzia <mute_type>: Sasha imposta il muto su <mute_type>.',
            '#unmute|ripristina <mute_type>: Sasha rimuove il muto su <mute_type>.',
            ...
            '#mute|silenzia <group_id> <mute_type>: Sasha imposta il muto su <mute_type> in <group_id>.',
            '#unmute|ripristina <group_id> <mute_type>: Sasha rimuove il muto su <mute_type> in <group_id>.',
            '(#[textual]muteslist|lista muti) <group_id>: Sasha manda la lista dei muti di <group_id>.',
            '(#lock|[sasha] blocca) <group_id> <setting_type>: Sasha blocca <setting_type> in <group_id>.',
            '(#unlock|[sasha] sblocca) <group_id> <setting_type>: Sasha sblocca <setting_type> in <group_id>.',
        ...
        help =
        {
            ...
            '(#[textual]help|sasha aiuto): Sasha manda la lista dei plugin per cui è disponibile l\'help.',
            '(#[textual]help|sasha aiuto) <plugin_name>|<plugin_number>: Sasha manda l\'aiuto per il plugin specificato.',
        ...
        info =
        {
            ...
            '#getrank|rango [<id>|<username>|<reply>|from]: Sasha manda il rank dell\'utente.',
        ...
        plugins =
        {
            ...
            'OWNER',
            '(#[textual]plugins|[sasha] lista plugins): Sasha manda la lista dei plugin.',
            ...
            'SUDO',
            '(#[textual]plugins|[sasha] lista plugins) [chat]: Sasha manda la lista dei plugin, se [chat] è specificato permette di modificare la lista del gruppo in cui è stato eseguito il comando.',
    ...
    en =
    {
        ...
        banhammer =
        {
            ...
            '(#warn|sasha avverti) <id>|<username>|<reply>|from [<reason>]: Sasha warns the specified user.',
        ...
        dogify =
        {
            ...
            'USER',
            '(#dogify|[sasha] doge) <your/words/with/slashes>: Sasha creates a pic with doge and the specified words.',
        },
        ...
        flame =
        {
            ...
            'MOD',
            '(#startflame|[sasha] flamma) <id>|<username>|<reply>|from: Sasha flames the specified user.',
        ...
        group_management =
        {
            ...
            '(#link|sasha link): Sasha sends the link of the group.',
            'MOD',
            ...
            '(#newlink|sasha crea link): Sasha creates a new link of the group.',
            '#[textual]settings: Sasha sends group\'s settings.',
            '#muteuser|voce <id>|<username>|<reply>|from: Sasha [un]mute the specified user.',
            '(#[textual]muteslist|lista muti): Sasha sends group\'s mutes.',
            ...
            '(#lock|[sasha] blocca) <setting_type>: Sasha locks <setting_type>.',
            '(#unlock|[sasha] sblocca) <setting_type>: Sasha unlocks <setting_type>.',
            ...
            '#mute|silenzia <mute_type>: Sasha mutes the specified parameter.',
            '#unmute|ripristina <mute_type>: Sasha unmutes the specified parameter.',
            ...
            '#mute|silenzia <group_id> <mute_type>: Sasha mutes <group_id>\'s <mute_type>.',
            '#unmute|ripristina <group_id> <mute_type>: Sasha unmutes <group_id>\'s <mute_type>.',
            '(#[textual]muteslist|lista muti) <group_id>: Sasha sends <group_id>\'s mutes.',
            '(#lock|[sasha] blocca) <group_id> <setting_type>: Sasha locks <group_id>\'s <setting_type>.',
            '(#unlock|[sasha] sblocca) <group_id> <setting_type>: Sasha unlocks <group_id>\'s <setting_type>.',
        ...
        help =
        {
            ...
            '(#[textual]help|sasha aiuto): Sasha sends a list of plugins for which there\'s the help.',
            '(#[textual]help|sasha aiuto) <plugin_name>|<plugin_number>: Sasha sends the help of the specified plugin.',
        ...
        info =
        {
            ...
            '#getrank|rango [<id>|<username>|<reply>|from]: Sasha sends the rank of the specified user.',
        ...
        plugins =
        {
            ...
            'OWNER',
            '(#[textual]plugins|[sasha] lista plugins): Sasha sends a list of plugins.',
            ...
            'SUDO',
            '(#[textual]plugins|[sasha] lista plugins) [chat]: Sasha sends a list of plugins, if [chat] is specified it allows to manage the plugins\' list of the group in which the command was executed.',
        ...
        webshot =
        {
            ...
            'MOD',
            '(#webshot|[sasha] webshotta) <url> [<size>]: Sasha does a screenshot of <url> and sends it, if <size> is the specified it sends of that dimension.',
            'Size can be:',
            'T: (120 x 90px)',
            'S: (200 x 150px)',
            'E: (320 x 240px)',
