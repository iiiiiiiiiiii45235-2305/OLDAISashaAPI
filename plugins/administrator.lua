    ...
    if is_admin(msg) then
        if msg.cb then
            ...
            elseif matches[2]:gsub('%d', '') == 'REQUESTSPAGEMINUS' then
                ...
                editMessage(msg.chat.id, msg.message_id, requestsPages(tonumber(matches[3] or(tonumber(matches[2]:match('%d')) + 1)) - tonumber(matches[2]:match('%d'))), keyboard_requests_pages(matches[3]))
