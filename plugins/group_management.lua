...
return {
    ...
    patterns =
    {
        ...
        "^[#!/]([Ss][Ee][Tt][Tt][Tt][Ii][Mm][Ee][Rr][Ee][Ss][Tt][Rr][Ii][Cc][Tt]) (%d+) (%d+) (%d+) (%d+) (%d+)$",
        "^[#!/]([Ss][Ee][Tt][Tt][Tt][Ii][Mm][Ee][Rr][Ee][Ss][Tt][Rr][Ii][Cc][Tt]) (%d+)$",
        "^[#!/]([Ss][Ee][Tt][Tt][Tt][Ii][Mm][Ee][Bb][Aa][Nn]) (%d+) (%d+) (%d+) (%d+) (%d+)$",
        "^[#!/]([Ss][Ee][Tt][Tt][Tt][Ii][Mm][Ee][Bb][Aa][Nn]) (%d+)$",
