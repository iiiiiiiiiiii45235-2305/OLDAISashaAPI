...
return {
    ...
    syntax =
    {
        ...
        "/lock|/mute arabic|bots|delword|flood|forward|gbanned|grouplink|groupname|groupnotices|groupphoto|leave|links|members|pmnotices|rtl|spam|strict|tagalert|all|audios|contacts|documents|games|gifs|locations|photos|stickers|text|tgservices|videos|video_notes|voice_notes|warns_punishment {punishment}",
        "/unlock|/unmute arabic|bots|delword|flood|forward|gbanned|grouplink|groupname|groupnotices|groupphoto|leave|links|members|pmnotices|rtl|spam|strict|tagalert|all|audios|contacts|documents|games|gifs|locations|photos|stickers|text|tgservices|videos|video_notes|voice_notes|warns_punishment",
        "/pin {reply}",
        "/silentpin {reply}",
        "/unpin",
        "/settitle {text}",
