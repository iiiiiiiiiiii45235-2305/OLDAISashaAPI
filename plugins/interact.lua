...
return {
    ...
    patterns =
    {
        ...
        "^[#!/]([Dd][Ee][Ll][Uu][Pp][Ll][Oo][Aa][Dd]%-[Pp][Hh][Oo][Tt][Oo])$",
        "^[#!/]([Dd][Ee][Ll][Rr][Ee][Cc][Oo][Rr][Dd]%-[Vv][Ii][Dd][Ee][Oo])$",
        "^[#!/]([Dd][Ee][Ll][Uu][Pp][Ll][Oo][Aa][Dd]%-[Vv][Ii][Dd][Ee][Oo])$",
        "^[#!/]([Dd][Ee][Ll][Rr][Ee][Cc][Oo][Rr][Dd]%-[Aa][Uu][Dd][Ii][Oo])$",
        "^[#!/]([Dd][Ee][Ll][Uu][Pp][Ll][Oo][Aa][Dd]%-[Aa][Uu][Dd][Ii][Oo])$",
        "^[#!/]([Dd][Ee][Ll][Uu][Pp][Ll][Oo][Aa][Dd]%-[Dd][Oo][Cc][Uu][Mm][Ee][Nn][Tt])$",
        "^[#!/]([Dd][Ee][Ll][Ff][Ii][Nn][Dd]%-[Ll][Oo][Cc][Aa][Tt][Ii][Oo][Nn])$",
        "^[#!/]([Dd][Ee][Ll][Rr][Ee][Cc][Oo][Rr][Dd]%-[Vv][Ii][Dd][Ee][Oo][Nn][Oo][Tt][Ee])$",
        "^[#!/]([Dd][Ee][Ll][Uu][Pp][Ll][Oo][Aa][Dd]%-[Vv][Ii][Dd][Ee][Oo][Nn][Oo][Tt][Ee])$",
        "^[#!/]([Tt][Yy][Pp][Ii][Nn][Gg])$",
        "^[#!/]([Uu][Pp][Ll][Oo][Aa][Dd]%-[Pp][Hh][Oo][Tt][Oo])$",
        "^[#!/]([Rr][Ee][Cc][Oo][Rr][Dd]%-[Vv][Ii][Dd][Ee][Oo])$",
        "^[#!/]([Uu][Pp][Ll][Oo][Aa][Dd]%-[Vv][Ii][Dd][Ee][Oo])$",
        "^[#!/]([Rr][Ee][Cc][Oo][Rr][Dd]%-[Aa][Uu][Dd][Ii][Oo])$",
        "^[#!/]([Uu][Pp][Ll][Oo][Aa][Dd]%-[Aa][Uu][Dd][Ii][Oo])$",
        "^[#!/]([Uu][Pp][Ll][Oo][Aa][Dd]%-[Dd][Oo][Cc][Uu][Mm][Ee][Nn][Tt])$",
        "^[#!/]([Ff][Ii][Nn][Dd]%-[Ll][Oo][Cc][Aa][Tt][Ii][Oo][Nn])$",
        "^[#!/]([Rr][Ee][Cc][Oo][Rr][Dd]%-[Vv][Ii][Dd][Ee][Oo][Nn][Oo][Tt][Ee])$",
        "^[#!/]([Uu][Pp][Ll][Oo][Aa][Dd]%-[Vv][Ii][Dd][Ee][Oo][Nn][Oo][Tt][Ee])$",
    },
    run = run,
    min_rank = 0,
    syntax =
    {
        ...
        "/[del]upload-document",
        "/[del]find-location",
        "/[del]record-videonote",
        "/[del]upload-videonote",
